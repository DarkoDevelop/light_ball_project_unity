...
public class DebugDraw
{
    ...
    public static void DrawSphere(Vector3 position, float radius, Color color, Material material)
    {
    ...
    public static void DrawCube(Vector3 position, Quaternion rotation, float size, Color color , Material material)
    {
